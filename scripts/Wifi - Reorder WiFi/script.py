...
preferred_SSID    = 'CCSD93-Staff'
second_SSID       = 'CCSD93-WPA'
next_to_last_SSID = 'xfinitywifi'
last_SSID         = 'CCSD93'
...
for i in interfaces.keys():
    ...
    # Check to see if our preferred or second SSID is in the list
    if (preferred_SSID in SSIDs) or (second_SSID in SSIDs):
        ...
        profiles.sort(key=lambda x: x.ssid() == second_SSID, reverse=True)
        # Now we move the preferred_SSID to the top
